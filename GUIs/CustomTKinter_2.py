...
combobox_label1 = ctk.CTkLabel(inner_frame, text="Combobox 1")
combobox_label1.grid(row=2, column=1, pady=5, padx=5)
combobox1 = ctk.CTkComboBox(inner_frame, values=["Option 1", "Option 2", "Option 3"])
combobox1.grid(row=2, column=2, pady=5, padx=5)

combobox_label2 = ctk.CTkLabel(inner_frame, text="Combobox 2")
combobox_label2.grid(row=2, column=3, pady=5, padx=5)
combobox2 = ctk.CTkComboBox(inner_frame, values=["Option 1", "Option 2", "Option 3"])
combobox2.grid(row=2, column=4, pady=5, padx=5)
...
combobox_label4 = ctk.CTkLabel(inner_frame, text="Combobox 4")
combobox_label4.grid(row=4, column=1, pady=5, padx=5)
combobox4 = ctk.CTkComboBox(inner_frame, values=["Option 1", "Option 2", "Option 3"])
combobox4.grid(row=4, column=2, pady=5, padx=5)

combobox_label5 = ctk.CTkLabel(inner_frame, text="Combobox 5")
combobox_label5.grid(row=5, column=1, pady=5)
combobox5 = ctk.CTkComboBox(inner_frame, values=["Option 1", "Option 2", "Option 3"])
combobox5.grid(row=5, column=2, pady=5, padx=5)

label4 = ctk.CTkLabel(inner_frame, text="Filepath Control Section")
label4.grid(row=6, columnspan=6, pady=10)

filepath_entry = ctk.CTkEntry(inner_frame)
filepath_entry.grid(row=7, columnspan=6, pady=5)

label5 = ctk.CTkLabel(inner_frame, text="Table Section")
label5.grid(row=8, columnspan=6, pady=10)
...
table_label.grid(row=9, columnspan=6)

label6 = ctk.CTkLabel(inner_frame, text="Graphs Section")
label6.grid(row=10, columnspan=6)
