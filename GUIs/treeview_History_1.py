...
root.geometry("500x700")  # Set initial size of the window to make everything visible
...
tree = ttk.Treeview(root, columns=('Item', 'Name'), show='headings', selectmode="browse")
...
bottom_label.pack(side='bottom', fill='x', pady=10)
