...
def Place_frame1(frame_, data_in, data_info_in):
    ...
    frame_.entry_path = ctk.CTkEntry(frame_, width=300)
    frame_.entry_path.grid(column=0, row=4, sticky="nw", padx=2, pady=2, columnspan=3)  # columnspan does not work
    print("datapath: ", data_info['data_path'], type(data_info['data_path']))
